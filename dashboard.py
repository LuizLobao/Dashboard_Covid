#https://www.youtube.com/watch?v=LPvchXRbstA&t=648s
...
fig = px.choropleth_mapbox(df_states, locations='estado', color='casosNovos', 
                           ...
                           opacity=0.4, hover_data={'casosAcumulado': True, 'casosNovos': True, 'obitosNovos': True, 'estado': True})
fig.update_layout(
...
app.layout = dbc.Container(
    dbc.Row([
        dbc.Col([
            ...
            html.P('Informe a data na qual deseja obter informações:', style={'margim-top': '40px'}),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.Span('Casos Confirmados Total:'),
